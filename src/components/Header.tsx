                    ...
                    <ul className="grid w-[400px] gap-3 p-4 bg-background">
                      <li>
                        <NavigationMenuLink asChild>
                          ...
                          >
                            <div className="text-sm font-medium leading-none">Management Control Center</div>
                            <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                              Full visibility and control across all sites with compliance management
                            </p>
                          </Link>
                        </NavigationMenuLink>
                      </li>
                      <li>
                        <NavigationMenuLink asChild>
                          <Link
                            ...
                            className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                          >
                            <div className="text-sm font-medium leading-none">Supplier eCommerce Portal</div>
                            <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                      ...
                      <li>
                        <NavigationMenuLink asChild>
                          <Link
                            ...
                            className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                          >
                            <div className="text-sm font-medium leading-none">Inventory Manager</div>
                            <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                              Real-time inventory tracking and automated controls
                            </p>
                          </Link>
                        </NavigationMenuLink>
                      </li>
                      <li>
                        <NavigationMenuLink asChild>
                          <Link
                            ...
                            className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                          >
                            <div className="text-sm font-medium leading-none">Storefront</div>
                            <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                      ...
                      <li>
                        <NavigationMenuLink asChild>
                          <Link
                            ...
                            className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                          >
                            <div className="text-sm font-medium leading-none">Product Configurator</div>
                            <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
